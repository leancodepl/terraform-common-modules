...
Using list that created artificial key from resource\_id / role name requires the resource to be created up front, forcing partial applies.
...
| <a name="input_azure_role_assignments"></a> [azure\_role\_assignments](#input\_azure\_role\_assignments) | n/a | <pre>map(object({<br>    role_name = string<br>    scope     = string<br>  }))</pre> | n/a | yes |
